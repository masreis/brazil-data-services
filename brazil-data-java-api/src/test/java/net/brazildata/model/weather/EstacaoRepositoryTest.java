package net.brazildata.model.weather;
...
//    @Test
    final void testSave() {
        try {
            ...
            Station estacao = Station.builder().altitude(1100.0f).wmoCode("cod").foundationDate(LocalDate.now())
                    .position(geom).region("RE").state("UF").build();
